<html>
	<head>
		...
		<script type="text/javascript" src="signup_action.php"></script>
	</head>
	<body>
		<div class="container">
			...
			<!--video, sign-up box, & description-->
				<div class="row"> 
					<div class="span12" style="position:relative">
						...
						<div id="description" class="gradient">
								<p class ="description"> <strong> metaLAB </strong> \mit&#601;-l&aelig;b\ <em>n.</em> <br>(1) an experimental research, design & development unit dedicated 
