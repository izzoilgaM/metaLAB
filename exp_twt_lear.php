...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<head>
		...
		<script type="text/javascript" src="js/carousel_media.js"></script>
...
<div class="projects innershadow">
				...
				<div id="project-header">
					<h2>The Lear Visualization</h2>
					<h1><a href="exp_twt.php">Teaching with Things</a></h1>
				</div>
				<div class="my_carousel">
		<div class="carousel_container shadow">
			<div id="carousel"></div>
		...
		<div class="carousel_data">
			...
			<div class="carousel_item">
				<div class="image">
					<iframe src="http://player.vimeo.com/video/60356106?title=0&amp;byline=0&amp;portrait=0&amp;color=ff1300" width="640" height="360" frameborder="0" 
					webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
				</div>
			</div>
			<div class="carousel_item">
				<div class="image">
					<img class="shadow" src="img/projects/twt/lear/Controller.jpg" alt="Controller"/>
				</div>
			</div>	
			
			<div class="carousel_item">
				<div class="image">
					<img class="shadow" src="img/projects/twt/lear/applet_1.jpg" alt="Applet 1"/>
				</div>
			</div>
			
			<div class="carousel_item">
				<div class="image">
					<img class="shadow" src="img/projects/twt/lear/applet_2.jpg" alt="Applet 2"/>
				</div>
			</div>
			
			<div class="carousel_item">
				<div class="image">
					<img class="shadow" src="img/projects/twt/lear/applet_2_Gallery.jpg" alt="Applet 2 Gallery"/>
				</div>
			</div>
			
			<div class="carousel_item">
				<div class="image">
					<img class="shadow" src="img/projects/twt/lear/applet_3_Date.jpg" alt="Applet 3 Date"/>
				</div>
			</div>
			
			<div class="carousel_item">
				<div class="image">
					<img class="shadow" src="img/projects/twt/lear/applet_3_Paper Type.jpg" alt="Applet 3 Paper Type"/>
				</div>
			</div>
			
			<div class="carousel_item">
				<div class="image">
					<img class="shadow" src="img/projects/twt/lear/applet_4.jpg" alt="Applet 4"/>
				</div>
			</div>
		</div>
